...
<link rel="shortcut icon" type="image/png"
	href="/resources/assets/images/icon/favicon.ico">
						...
						<ul class="metismenu" id="menu">
							<c:forEach var="course" items="${courses}">
								<li class="active"><a href="javascript:void(0)"
									aria-expanded="true">${course.name}</a>
									<ul class="collapse">
										<c:forEach var="exercise" items="${course.exercises}">
											<li class="active"><a
												href="<%=Routes.exercisesNew%>?exerciseId=${exercise.id}">${exercise.name}</a></li>
										</c:forEach>
									</ul></li>
							</c:forEach>
						</ul>
					...
					<div class="col-sm-6 clearfix">
						<div class="user-profile pull-right">
							<img class="avatar user-thumb"
								src="/resources/assets/images/author/avatar.png" alt="avatar">
							<h4 class="user-name dropdown-toggle" data-toggle="dropdown">
								Usuário <i class="fa fa-angle-down"></i>
							</h4>
